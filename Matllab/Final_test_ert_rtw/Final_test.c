...
static void SystemProp_matlabCodegenSetA_fd(codertarget_arduinobase_in_fd_T *obj,
  boolean_T value)
{
  /* Start for MATLABSystem: '<S3>/Analog Input1' incorporates:
...
static void matlabCodegenHandle_matlabCo_fd(codertarget_arduinobase_in_fd_T *obj)
{
  ...
  /* End of Start for MATLABSystem: '<S3>/Analog Input1' */
}
...
void Final_test_step(void)
{
  ...
  if (rtmIsMajorTimeStep(Final_test_M)) {
    ...
    /* ZeroOrderHold: '<S3>/Zero-Order Hold1' incorporates:
    ...
    p = false;
    p_0 = true;
    if (!(Final_test_DW.obj_i.SampleTime == Final_test_P.AnalogInput1_SampleTime))
    {
      p_0 = false;
    }
    ...
    if (!p) {
      Final_test_DW.obj_i.SampleTime = Final_test_P.AnalogInput1_SampleTime;
    }

    MW_AnalogIn_Start(Final_test_DW.obj_i.MW_ANALOGIN_HANDLE);

    /* ZeroOrderHold: '<S3>/Zero-Order Hold' incorporates:
     *  MATLABSystem: '<S3>/Analog Input1'
     *  MATLABSystem: '<S3>/Analog Input1'
     */
    MW_AnalogInSingle_ReadResult(Final_test_DW.obj_i.MW_ANALOGIN_HANDLE,
      &Final_test_B.ZeroOrderHold, 3);
  }
...
void Final_test_initialize(void)
{
  ...
  /* External mode info */
  Final_test_M->Sizes.checksums[0] = (2795633967U);
  Final_test_M->Sizes.checksums[1] = (3058966893U);
  Final_test_M->Sizes.checksums[2] = (2594487946U);
  Final_test_M->Sizes.checksums[3] = (3091844017U);
...

  {
    ...
    /* Start for MATLABSystem: '<S3>/Analog Input1' */
    Final_test_DW.obj_i.matlabCodegenIsDeleted = true;
    obj = &Final_test_DW.obj_i;
    Final_test_DW.obj_i.isInitialized = 0;
    obj->Hw.AvailablePwmPinNames.f1 = '2';
    obj->Hw.AvailablePwmPinNames.f2 = '3';
    obj->Hw.AvailablePwmPinNames.f3 = '4';
    obj->Hw.AvailablePwmPinNames.f4 = '5';
    ...
    obj->Hw.AvailablePwmPinNames.f12[0] = '1';
    obj->Hw.AvailablePwmPinNames.f12[1] = '3';
    Final_test_DW.obj_i.matlabCodegenIsDeleted = false;
    Final_test_DW.objisempty_o = true;
    Final_test_DW.obj_i.SampleTime = Final_test_P.AnalogInput1_SampleTime;
    obj = &Final_test_DW.obj_i;
    Final_test_DW.obj_i.isSetupComplete = false;
    Final_test_DW.obj_i.isInitialized = 1;
    obj->MW_ANALOGIN_HANDLE = MW_AnalogInSingle_Open(3U);
    trigger_val = MW_ANALOGIN_SOFTWARE_TRIGGER;
    MW_AnalogIn_SetTriggerSource(Final_test_DW.obj_i.MW_ANALOGIN_HANDLE,
      trigger_val, 0U);
    Final_test_DW.obj_i.isSetupComplete = true;
  }
...
void Final_test_terminate(void)
{
  ...
  matlabCodegenHandle_matlabCo_fd(&Final_test_DW.obj_i);
}
