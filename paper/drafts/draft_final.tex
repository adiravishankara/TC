...
\author{\IEEEauthorblockN{1\textsuperscript{st} Adithya Ravishankara}
	...
	In this paper we introduced a hot wire anemometer with the function of measuring the downwash rotor wind speed on MAV's. By this measurement we can calculate the thrust output of the propeller and 
