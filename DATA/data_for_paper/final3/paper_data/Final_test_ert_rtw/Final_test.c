...
void Final_test_step(void)
{
  ...
  if (rtmIsMajorTimeStep(Final_test_M)) {
    ...
    switch (Final_test_DW.If_ActiveSubsystem) {
     case 0:
      ...
      /* SignalConversion: '<S55>/OutportBufferForOut1' incorporates:
       *  Constant: '<S3>/Constant4'
       */
  ...
  if ((Final_test_B.TransferFcn1 < 0.0) && (Final_test_P.Constant_Value_n >
    ...
    Final_test_B.Product1 = -rt_powd_snf(-Final_test_B.TransferFcn1,
   ...
   *  Gain: '<S10>/Gain'
   */
  Final_test_B.Sum = Final_test_P.Gain_Gain_j * Final_test_B.Product1 +
  ...
  if (rtmIsMajorTimeStep(Final_test_M)) {
     ...
     */
    Final_test_B.Sum_b = Final_test_B.Merge - Final_test_P.Constant1_Value_i;

    /* Math: '<S15>/Math Function1' incorporates:
     *  Constant: '<S15>/a'
     */
    if ((Final_test_B.Sum_b < 0.0) && (Final_test_P.a_Value > floor
         (Final_test_P.a_Value))) {
      Final_test_B.Product1 = -rt_powd_snf(-Final_test_B.Sum_b,
        Final_test_P.a_Value);
    } else {
      Final_test_B.Product1 = rt_powd_snf(Final_test_B.Sum_b,
        Final_test_P.a_Value);
     ...
     *  Sum: '<S15>/Sum1'
     */
    Final_test_B.Product1 = (Final_test_P.b_Gain * Final_test_B.Product1 +
      Final_test_P.c_Value) * Final_test_B.Sum_b;
    ...
    for (i = 0; i < 2; i++) {
      Final_test_B.P_bar[i << 1] = (b_b[(i << 1) + 1] * Final_test_B.a[2] +
        b_b[i << 1] * Final_test_B.a[0]) + (real_T)R[i << 1];
      Final_test_B.P_bar[1 + (i << 1)] = (b_b[(i << 1) + 1] * Final_test_B.a[3]
        + b_b[i << 1] * Final_test_B.a[1]) + (real_T)R[(i << 1) + 1];
    }

    Final_test_B.Product1 = 1.0 / (((0.0 * Final_test_B.P_bar[3] +
      Final_test_B.P_bar[2]) * 0.0 + (0.0 * Final_test_B.P_bar[1] +
      Final_test_B.P_bar[0])) + 1.0);
    ...
    Final_test_B.K[1] = (Final_test_B.P_bar[3] * 0.0 + Final_test_B.P_bar[1]) *
      Final_test_B.Product1;
    Final_test_B.z = Final_test_B.Sum - (0.0 * Final_test_B.xh_bar[1] +
    ...
    if (Final_test_P.ManualSwitch1_CurrentSetting == 1) {
      ...
      Final_test_B.ManualSwitch1[4] = Final_test_B.Sum;
    ...
    for (i = 0; i < 2; i++) {
      /* MATLAB Function: '<S1>/MATLAB Function' */
      Final_test_DW.xh[i] = Final_test_B.K[i] * Final_test_B.z +
      ...
      if (Final_test_P.ManualSwitch1_CurrentSetting == 1) {
        ...
        /* Math: '<S13>/Power1' incorporates:
         *  Constant: '<S13>/Constant1'
         *  MATLAB Function: '<S1>/MATLAB Function'
         */
        if ((Final_test_DW.xh[i] < 0.0) && (Final_test_P.Constant1_Value_g >
             floor(Final_test_P.Constant1_Value_g))) {
          Final_test_B.Product1 = -rt_powd_snf(-Final_test_DW.xh[i],
            Final_test_P.Constant1_Value_g);
        } else {
          Final_test_B.Product1 = rt_powd_snf(Final_test_DW.xh[i],
            Final_test_P.Constant1_Value_g);
        }

        /* End of Math: '<S13>/Power1' */

        /* Math: '<S13>/Power' incorporates:
         *  Constant: '<S13>/Constant'
         *  MATLAB Function: '<S1>/MATLAB Function'
         */
        if ((Final_test_DW.xh[i] < 0.0) && (Final_test_P.Constant_Value_g >
             floor(Final_test_P.Constant_Value_g))) {
          tmp = -rt_powd_snf(-Final_test_DW.xh[i], Final_test_P.Constant_Value_g);
        } else {
          tmp = rt_powd_snf(Final_test_DW.xh[i], Final_test_P.Constant_Value_g);
        }

        /* End of Math: '<S13>/Power' */

        /* Math: '<S13>/Power2' incorporates:
         *  Constant: '<S13>/Constant3'
         *  MATLAB Function: '<S1>/MATLAB Function'
         */
        if ((Final_test_DW.xh[i] < 0.0) && (Final_test_P.Constant3_Value > floor
             (Final_test_P.Constant3_Value))) {
          tmp_0 = -rt_powd_snf(-Final_test_DW.xh[i],
                               Final_test_P.Constant3_Value);
        } else {
          tmp_0 = rt_powd_snf(Final_test_DW.xh[i], Final_test_P.Constant3_Value);
        }

        /* End of Math: '<S13>/Power2' */
        Final_test_B.ManualSwitch1[i + 8] = (((Final_test_P.Gain2_Gain *
          Final_test_DW.xh[i] + Final_test_P.Constant2_Value) +
          Final_test_P.Gain1_Gain_i * Final_test_B.Product1) +
          Final_test_P.Gain_Gain_d * tmp) + Final_test_P.Gain3_Gain * tmp_0;
      } else {
        Final_test_B.ManualSwitch1[i + 6] = 0.0;
        Final_test_B.ManualSwitch1[i + 8] = 0.0;
      }
    }
     ...
     *  Constant: '<S59>/a'
     */
    if ((Final_test_B.Sum_b < 0.0) && (Final_test_P.a_Value_d > floor
     ...
     *  Sum: '<S59>/Sum1'
     */
    Final_test_B.Gain2 = (Final_test_P.b_Gain_n * Final_test_B.Product1 +
                          Final_test_P.c_Value_e) * Final_test_B.Sum_b *
      Final_test_P.Gain2_Gain_i;
  }
   ...
   *  Gain: '<S11>/Gain1'
   */
  Final_test_B.Sum_k = (Final_test_B.Gain2 - Final_test_P.Gain1_Gain_h *
  ...
  Final_test_B.Sum_b = Final_test_DW.obj.pStatistic->pCumRevIndex;
  Final_test_B.Product1 = Final_test_DW.obj.pStatistic->pCumSum;
  ...
  Final_test_B.Product1 += Final_test_B.TransferFcn1;
  i = (int32_T)Final_test_B.Sum_b - 1;
  Final_test_B.z = Final_test_B.P_bar[i] + Final_test_B.Product1;
  Final_test_B.P_bar[i] = Final_test_B.TransferFcn1;
  if (Final_test_B.Sum_b != 4.0) {
    Final_test_B.Sum_b++;
  } else {
    Final_test_B.Sum_b = 1.0;
    Final_test_B.Product1 = 0.0;
  ...
  Final_test_DW.obj.pStatistic->pCumSum = Final_test_B.Product1;
  ...
  Final_test_DW.obj.pStatistic->pCumRevIndex = Final_test_B.Sum_b;
  ...
  if (rtmIsMajorTimeStep(Final_test_M)) {
     ...
     *  Sum: '<S61>/Sum1'
     */
    Final_test_B.Gain2_e = (Final_test_P.b_Gain_j * rt_powd_snf(0.0,
      Final_test_P.a_Value_g) + Final_test_P.c_Value_j) * 0.0 *
      Final_test_P.Gain2_Gain_g;
  }

  /* Integrator: '<S12>/Integrator' */
  Final_test_B.Integrator_p = Final_test_X.Integrator_CSTATE_h;
   ...
   */
  Final_test_B.Sum_g = (Final_test_B.Gain2_e - Final_test_P.Gain1_Gain_a *
                        Final_test_X.Integrator1_CSTATE_b) -
    Final_test_P.Gain_Gain_i * Final_test_B.Integrator_p;
  if (rtmIsMajorTimeStep(Final_test_M)) {
    if (rtmIsMajorTimeStep(Final_test_M)) {
...
void Final_test_derivatives(void)
{
  ...
  _rtXdot->Integrator_CSTATE = Final_test_B.Sum_k;

  /* Derivatives for Integrator: '<S12>/Integrator' */
  _rtXdot->Integrator_CSTATE_h = Final_test_B.Sum_g;

  /* Derivatives for Integrator: '<S12>/Integrator1' */
  _rtXdot->Integrator1_CSTATE_b = Final_test_B.Integrator_p;
}
...
void Final_test_initialize(void)
{
  ...
  /* External mode info */
  Final_test_M->Sizes.checksums[0] = (2088849749U);
  Final_test_M->Sizes.checksums[1] = (253086746U);
  Final_test_M->Sizes.checksums[2] = (421553320U);
  Final_test_M->Sizes.checksums[3] = (332772512U);

  {
    ...
    systemRan[6] = (sysRanDType *)&Final_test_DW.IfActionSubsystem_SubsysRanBC;
    systemRan[7] = (sysRanDType *)&Final_test_DW.IfActionSubsystem1_SubsysRanBC;
...

  {
    ...
    /* Start for FromWorkspace: '<S7>/FromWs' */
    {
      static real_T pTimeValues0[] = { 0.0, 10.0, 10.0, 12.0, 12.0, 30.0, 30.0,
        90.0, 90.0, 150.0, 150.0, 210.0, 210.0, 270.0, 270.0, 330.0, 330.0,
        390.0, 390.0, 450.0, 450.0, 510.0, 510.0, 570.0, 570.0, 600.0 } ;

      static real_T pDataValues0[] = { 0.0, 0.0, 20.0, 20.0, 0.0, 0.0, 4.0, 4.0,
        6.0, 6.0, 8.0, 8.0, 10.0, 10.0, 12.0, 12.0, 14.0, 14.0, 16.0, 16.0, 18.0,
        18.0, 20.0, 20.0, 1.0, 1.0 } ;
  ...
  Final_test_X.Integrator_CSTATE_h = Final_test_P.Integrator_IC_l;

  /* InitializeConditions for Integrator: '<S12>/Integrator1' */
  Final_test_X.Integrator1_CSTATE_b = Final_test_P.Integrator1_IC_o;
