###########################################################################
## Makefile generated for Simulink model 'step_test'. 
## 
## Makefile     : step_test.mk
## Generated on : Mon Aug 27 14:28:19 2018
## MATLAB Coder version: 4.0 (R2018a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/step_test.elf
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /home/adiravishankara/Documents/GIT/TC/DATA/data_for_paper/final2
ARCH                      = glnxa64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = step_test_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/step_test.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I/home/adiravishankara/Documents/MATLAB/SupportPackages/R2018a/toolbox/target/shared/svd/include -I$(START_DIR)/step_test_ert_rtw -I/home/adiravishankara/Documents/GIT/TC/Matllab -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(ARDUINO_SAM_ROOT)/hardware/sam/1.6.11/system/libsam -I$(ARDUINO_SAM_ROOT)/hardware/sam/1.6.11/system/CMSIS/CMSIS/Include -I$(ARDUINO_SAM_ROOT)/hardware/sam/1.6.11/system/CMSIS/Device/ATMEL -I$(ARDUINO_SAM_ROOT)/hardware/sam/1.6.11/cores/arduino -I$(ARDUINO_SAM_ROOT)/hardware/sam/1.6.11/cores/arduino/avr -I$(ARDUINO_SAM_ROOT)/hardware/sam/1.6.11/variants/arduino_due_x -I/home/adiravishankara/Documents/MATLAB/SupportPackages/R2018a/toolbox/target/supportpackages/arduinotarget/include -I/home/adiravishankara/Documents/MATLAB/SupportPackages/R2018a/toolbox/target/supportpackages/arduinotarget/scheduler/include -I/home/adiravishankara/Documents/MATLAB/SupportPackages/R2018a/toolbox/target/supportpackages/arduinobase/include -I/home/adiravishankara/Documents/MATLAB/SupportPackages/R2018a/toolbox/target/shared/externalmode_daemon/include
...
DEFINES_STANDARD = -DMODEL=step_test -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DUNIX
...
%.o : $(START_DIR)/step_test_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : $(START_DIR)/step_test_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/step_test_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : $(START_DIR)/step_test_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : $(START_DIR)/step_test_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o $@ $<
