...
typedef struct {
  ...
  real_T ManualSwitch1[10];            /* '<Root>/Manual Switch1' */
...
typedef struct {
  ...
  real_T Integrator_DSTATE;            /* '<S58>/Integrator' */
...
typedef struct {
  ...
  real_T Integrator_CSTATE_h;          /* '<S12>/Integrator' */
...
typedef struct {
  ...
  boolean_T Integrator_CSTATE_h;       /* '<S12>/Integrator' */
...
struct P_Final_test_T_ {
  ...
  real_T c_Value;                      /* Expression: 0.005561
                                        * Referenced by: '<S15>/c'
                                        */
  real_T Constant2_Value;              /* Expression: 1.8430
                                        * Referenced by: '<S13>/Constant2'
                                        */
  real_T Gain2_Gain;                   /* Expression: 12.29
                                        * Referenced by: '<S13>/Gain2'
                                        */
  real_T Constant1_Value_g;            /* Expression: 2
                                        * Referenced by: '<S13>/Constant1'
                                        */
  real_T Gain1_Gain_i;                 /* Expression: -3.409
                                        * Referenced by: '<S13>/Gain1'
                                        */
  real_T Constant_Value_g;             /* Expression: 3
                                        * Referenced by: '<S13>/Constant'
                                        */
  real_T Gain_Gain_d;                  /* Expression: 1.008
                                        * Referenced by: '<S13>/Gain'
                                        */
  real_T Constant3_Value;              /* Expression: 4
                                        * Referenced by: '<S13>/Constant3'
                                        */
  real_T Gain3_Gain;                   /* Expression: -.1746
  ...
  real_T Integrator_IC_l;              /* Expression: 0
                                        ...
                                        */
  real_T Gain_Gain_i;                  /* Expression: 3
                                        * Referenced by: '<S12>/Gain'
                                        */
  real_T Integrator1_IC_o;             /* Expression: 0
                                        * Referenced by: '<S12>/Integrator1'
                                        */
  real_T Gain1_Gain_a;                 /* Expression: 4
                                        * Referenced by: '<S12>/Gain1'
                                        */
  real_T a_Value_g;                    /* Expression: .99
                                        * Referenced by: '<S61>/a'
                                        */
  real_T b_Gain_j;                     /* Expression: .003
                                        * Referenced by: '<S61>/b'
                                        */
  real_T c_Value_j;                    /* Expression: .057
                                        * Referenced by: '<S61>/c'
                                        */
 ...
 * Block '<S60>/Gain2' : Unused code path elimination
 * Block '<S60>/Gain3' : Unused code path elimination
 * Block '<S60>/Power' : Unused code path elimination
 * Block '<S60>/Power1' : Unused code path elimination
 * Block '<S60>/Power2' : Unused code path elimination
 ...
 * '<S12>'  : 'Final_test/Thrust Model1'
 * '<S13>'  : 'Final_test/thr2pwm '
 * '<S14>'  : 'Final_test/Kalman Filter/MATLAB Function'
 * '<S15>'  : 'Final_test/Kalman Filter/Subsystem1'
 * '<S16>'  : 'Final_test/Kalman Filter1/CalculatePL'
 * '<S17>'  : 'Final_test/Kalman Filter1/CalculateYhat'
 * '<S18>'  : 'Final_test/Kalman Filter1/DataTypeConversionA'
 * '<S19>'  : 'Final_test/Kalman Filter1/DataTypeConversionB'
 * '<S20>'  : 'Final_test/Kalman Filter1/DataTypeConversionC'
 * '<S21>'  : 'Final_test/Kalman Filter1/DataTypeConversionD'
 * '<S22>'  : 'Final_test/Kalman Filter1/DataTypeConversionG'
 * '<S23>'  : 'Final_test/Kalman Filter1/DataTypeConversionH'
 * '<S24>'  : 'Final_test/Kalman Filter1/DataTypeConversionN'
 * '<S25>'  : 'Final_test/Kalman Filter1/DataTypeConversionP0'
 * '<S26>'  : 'Final_test/Kalman Filter1/DataTypeConversionQ'
 * '<S27>'  : 'Final_test/Kalman Filter1/DataTypeConversionR'
 * '<S28>'  : 'Final_test/Kalman Filter1/DataTypeConversionX0'
 * '<S29>'  : 'Final_test/Kalman Filter1/DataTypeConversionu'
 * '<S30>'  : 'Final_test/Kalman Filter1/MemoryP'
 * '<S31>'  : 'Final_test/Kalman Filter1/Observer'
 * '<S32>'  : 'Final_test/Kalman Filter1/ReducedQRN'
 * '<S33>'  : 'Final_test/Kalman Filter1/ScalarExpansionP0'
 * '<S34>'  : 'Final_test/Kalman Filter1/ScalarExpansionQ'
 * '<S35>'  : 'Final_test/Kalman Filter1/ScalarExpansionR'
 * '<S36>'  : 'Final_test/Kalman Filter1/UseCurrentEstimator'
 * '<S37>'  : 'Final_test/Kalman Filter1/checkA'
 * '<S38>'  : 'Final_test/Kalman Filter1/checkB'
 * '<S39>'  : 'Final_test/Kalman Filter1/checkC'
 * '<S40>'  : 'Final_test/Kalman Filter1/checkD'
 * '<S41>'  : 'Final_test/Kalman Filter1/checkEnable'
 * '<S42>'  : 'Final_test/Kalman Filter1/checkG'
 * '<S43>'  : 'Final_test/Kalman Filter1/checkH'
 * '<S44>'  : 'Final_test/Kalman Filter1/checkN'
 * '<S45>'  : 'Final_test/Kalman Filter1/checkP0'
 * '<S46>'  : 'Final_test/Kalman Filter1/checkQ'
 * '<S47>'  : 'Final_test/Kalman Filter1/checkR'
 * '<S48>'  : 'Final_test/Kalman Filter1/checkReset'
 * '<S49>'  : 'Final_test/Kalman Filter1/checkX0'
 * '<S50>'  : 'Final_test/Kalman Filter1/checku'
 * '<S51>'  : 'Final_test/Kalman Filter1/checky'
 * '<S52>'  : 'Final_test/Kalman Filter1/Observer/MeasurementUpdate'
 * '<S53>'  : 'Final_test/Kalman Filter1/UseCurrentEstimator/Enabled Subsystem'
 * '<S54>'  : 'Final_test/Output/Compare To Constant'
 * '<S55>'  : 'Final_test/Output/If Action Subsystem'
 * '<S56>'  : 'Final_test/Output/If Action Subsystem1'
 * '<S57>'  : 'Final_test/Subsystem1/Detect Change'
 * '<S58>'  : 'Final_test/Subsystem1/Discrete PID Controller'
 * '<S59>'  : 'Final_test/Thrust Model/Subsystem'
 * '<S60>'  : 'Final_test/Thrust Model1/Poly4Wind '
 * '<S61>'  : 'Final_test/Thrust Model1/Subsystem'
 */
